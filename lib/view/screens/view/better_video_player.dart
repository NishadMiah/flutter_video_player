...
import 'package:flutter_video_player/view/screens/controller/better_video_player_controller.dart';
...
class _VideoPlayerMainState extends State<VideoPlayerMain> {
  late BetterVideoController controller;

  @override
  void initState() {
    super.initState();
    controller = Get.put(BetterVideoController(videoUrl: widget.videoUrl, isLive: widget.isLive));
        ...
        return GestureDetector(
          ...
          child: Stack(
            children: [
              ...
              Center(
                child: AspectRatio(
                  aspectRatio: controller.betterPlayerController.videoPlayerController!.value.aspectRatio ?? 16 / 9,
                  ...
                  () => SliderTheme(
                    ...
                    child: Slider(
                      ...
                      onChanged: controller.isLocked.value
                          ? null
                          : (value) => controller.seekTo(Duration(seconds: value.toInt())),
